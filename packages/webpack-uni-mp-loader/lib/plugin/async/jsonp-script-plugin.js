...
class UniMpJsonpScriptPlugin {
  ...
  apply (compiler) {
    ...
    compiler.hooks.compilation.tap(pluginName, compilation => {
      ...
      mainTemplate.hooks.jsonpScript.tap(pluginName, (_, chunk, hash) => {
      ...
      mainTemplate.hooks.requireEnsure.tap('UniMpJsonpScriptPlugin load', (source, chunk, hash) => {
        return Template.asString([
...
module.exports = UniMpJsonpScriptPlugin
