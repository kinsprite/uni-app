...
const { loadConfigs, loadSubPkgRoots } = require('./helper/async-component-config')
const { globalTagSet } = require('./helper/mp-components')
...
class UniMpAsyncComponentWebpackPlugin {
  /**
...
module.exports = UniMpAsyncComponentWebpackPlugin
